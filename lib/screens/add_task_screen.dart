...
//     int _complexityLevel = 3; // Default mid-level complexity
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Complexity Level:', style: TextStyle(fontSize: 16)),
                    Slider(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                DurationEstimator.formatDuration(_estimatedDuration),
                                style: TextStyle(
                                  fontSize: 18,
                                  color: Theme.of(context).primaryColor,
                                  fontWeight: FontWeight.bold,
